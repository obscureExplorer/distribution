 ...
 */
public class DifferentTeacherAndUnmovableRoomSwapMoveFilter implements SelectionFilter<TimeTablingProblem, SwapMove> {
    ...
    public boolean accept(ScoreDirector<TimeTablingProblem> scoreDirector, SwapMove move) {
        ...
        return !Objects.equals(leftLecture.getTeacher(),rightLecture.getTeacher()) && !leftLecture.isRoomUnmovable() && !rightLecture.isRoomUnmovable();
    }
}
